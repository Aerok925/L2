...
// Данный паттерн позволяет повысить гибкость распределения обязанностей между объектами
// Так как у запроса нет явного получателя, то обработка самого запроса также не гарантируется
